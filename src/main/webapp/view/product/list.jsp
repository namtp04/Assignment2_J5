...
<div class="container">
    <h1 class="mb-3 mt-5">Product Management</h1>
    <a class="btn btn-outline-success" href="/product/view-add">Add</a>
    <div class="d-flex justify-content-end">
        <form id="colorSearchForm" action="/product/search" method="post">
            <div class="input-group">
                <input name="productSearchValue" type="text" class="form-control" placeholder="Enter name product"
                       aria-label="Search customer" value="${param.productSearchValue}">
