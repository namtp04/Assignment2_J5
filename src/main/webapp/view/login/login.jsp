            ...
            <div class="card-body">
                <form action="/auth/login-action" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="${loginReq.username}" name="username">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="${loginReq.password}" name="password">
                        <c:if test="${not empty errors}">
                    ...
                    <input type="text"value="${loginReq.trangThai}" name="trangThai" style="display: none">
