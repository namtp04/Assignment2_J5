...
<div class="container">
    <h1 class="text-center mb-3 mt-5">Update producer</h1>
    <div class="d-flex justify-content-center">
        <div class="card w-50 d-flex justify-content-center">
            <div class="card-body">
                <form action="/NSX/update" method="post">
                    <input type="text" class="form-control" value="${nsx.id}" name="id" style="display: none">
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                        <a href="/NSX/list" class="btn btn-secondary">Back</a>
