...
<div class="container">
    <h1 class="mb-3 mt-5">Color Management</h1>
    <a class="btn btn-outline-success" href="/color/view-add">Add</a>
    <div class="d-flex justify-content-end">
        <form id="colorSearchForm" action="/color/search" method="post">
            <div class="input-group">
                <input name="colorSearchValue" type="text" class="form-control" placeholder="Enter name color"
                       aria-label="Search customer" value="${param.colorSearchValue}">
    ...
    <table class="table">
        ...
        <c:forEach items="${lstCL}" var="cl">
            <tr>
                ...
                <td>${cl.ten}</td>
                <td>
                    <a class="btn btn-outline-warning" href="/color/view-update/${cl.id}">Update</a>
                    <a onclick="return confirm('Do you want to delete this item?')" class="btn btn-outline-danger"
                       href="/color/delete/${cl.id}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        <c:if test="${lstCL.size()==0}">
            <tr>
