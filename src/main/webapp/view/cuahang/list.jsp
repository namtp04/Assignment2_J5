...
<div class="container">
    <h1 class="mb-3 mt-5">Quản lý cửa hàng</h1>
    <a class="btn btn-outline-success" href="/cua-hang/view-add">Add</a>
    <div class="d-flex justify-content-end">
        <form action="/cua-hang/search" method="post">
            <div class="input-group">
                <input name="cuaHangSearchValue" type="text" class="form-control" placeholder="Enter name cua hang"
                       aria-label="Search customer" value="${param.cuaHangSearchValue}">
    ...
    <table class="table">
        ...
        <c:forEach items="${lstCH}" var="cl">
            <tr>
                ...
                <td>${cl.quocGia}</td>
                <td>
                    <a class="btn btn-outline-warning" href="/cua-hang/view-update/${cl.id}">Update</a>
                    <a onclick="return confirm('Do you want to delete this item?')" class="btn btn-outline-danger"
                       href="/cua-hang/delete/${cl.id}">Delete</a>
                </td>
            </tr>
        </c:forEach>
...
<script>
    window.onload = function() {
        ...
        alert('${deleteFail}');
        window.location.href='/cua-hang/list';
        </c:if>
    };
</script>
</body>
